...
%git clone https://github.com/davidoc/todo.txt-vim.git
...
\sthead{Import from SVN}
    \cc{\lstinline{git svn clong -s SVN_REPO_URL LOCAL_DIR \&\& cd LOCAL_DIR}}
